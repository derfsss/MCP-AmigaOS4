...
| `wb_screenshot` | `wb.screenshot` — capture a screen to PNG on the target, download it, optionally inline it as base64. Works on real hardware, unlike the QMP-based `qemu_screenshot`. |
